...
<body>
	...
	<form:form action="/lowczy/huntingplan/updated" method="POST"
		modelAttribute="huntingPlan">
		
		<form:hidden path="id"/>
		<form:hidden path="huntingSeason"/>
		...
		<table border="1px solid black">
			...
			<tr>
				<td><s:message code="hunting.plan" /> <c:out
						value="${huntingPlan.huntingSeason }" /></td>
			</tr>
			<tr>
