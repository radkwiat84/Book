...
<body>
	...
	<table border="1px solid black">
		...
		<tr>
			...
			<td><s:message code="hunting.plan.year" /></td>
			<td><s:message code="hunting.plan.action" /></td>
		</tr>
		<c:forEach var="hP" items="${huntingPlanList }">
			<tr>
				<td><c:out value="${hP.id }" /></td>
				<td><c:out value="${hP.year }" /></td>
				<td><input type="button"
					value="<s:message code='button.open'/>"
					onclick="window.location.href='${pageContext.request.contextPath}/upuser/huntingplan/${hP.id }'">
					<br /> <input type="button"
					value="<s:message code='button.edit'/>"
					onclick="window.location.href='${pageContext.request.contextPath}/upuser/huntingplan/update/${hP.id }'"></td>
			</tr>
